...
The AI Software Template that was executed comes with a sample application. This application will be built from https://github.com/jdubrick-ai/test-2-jul15, stored in [quay.io/jdubrick-ai/test-2-jul15](https://quay.io/jdubrick-ai/test-2-jul15) and deployed through ArgoCD. 
